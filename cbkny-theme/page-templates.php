...
<main class="container">
  ...
  <nav style="margin: 1rem 0; font-size: 0.9rem;">
    ...
    <span style="color: var(--cbkny-pink);">Templates</span>
  </nav>

  <section class="hero">
    <h1>Free Cannabis Business Templates</h1>
    <p>Ready-to-use Excel templates designed specifically for cannabis businesses</p>
  </section>
  ...
  <section class="grid" style="grid-template-columns: repeat(auto-fit, minmax(400px, 1fr)); gap: 2rem; margin: 4rem 0;">
    ...
    <div class="card" style="padding: 2rem; text-align: center;">
      ...
      <p style="margin-bottom: 1.5rem;">Excel template for tracking Cost of Goods Sold, inventory, and 280E-compliant expense categorization.</p>
      ...
      <button class="btn btn-primary" onclick="openResourceModal('cogs-template')" style="width: 100%; max-width: 100%; display: block; text-align: center; box-sizing: border-box;">Download Template</button>
    </div>
    ...
    <div class="card" style="padding: 2rem; text-align: center;">
      ...
      <h3 style="color: var(--cbkny-pink); margin-bottom: 1rem;">Cannabis Business Budget Template</h3>
      <p style="margin-bottom: 1.5rem;">Comprehensive budget planning template with cannabis-specific expense categories and revenue projections.</p>
      <ul style="text-align: left; margin-bottom: 2rem; font-size: 0.9rem; list-style: none; padding-left: 0;">
        <li style="margin-bottom: 0.5rem;">✓ Cannabis-specific categories</li>
        <li style="margin-bottom: 0.5rem;">✓ Monthly budget tracking</li>
        <li style="margin-bottom: 0.5rem;">✓ Variance analysis</li>
        <li style="margin-bottom: 0.5rem;">✓ Cash flow projections</li>
      </ul>
      <button class="btn btn-primary" onclick="openResourceModal('budget-template')" style="width: 100%; max-width: 100%; display: block; text-align: center; box-sizing: border-box;">Download Template</button>
    </div>
  </section>

  <section style="background: var(--cbkny-light-gray); padding: 3rem; border-radius: 1rem; margin: 4rem 0; text-align: center;">
    <h2 style="color: var(--cbkny-black); margin-bottom: 2rem;">Why Use Our Templates?</h2>
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 2rem; max-width: 800px; margin: 0 auto;">
      ...
      <div style="background: var(--cbkny-white); padding: 1.5rem; border-radius: 0.5rem;">
        <div style="color: var(--cbkny-pink); font-size: 2rem; margin-bottom: 1rem;"><i class="fas fa-check-circle"></i></div>
        <h4 style="color: var(--cbkny-black); margin-bottom: 1rem;">280E Compliant</h4>
        <p>Built with cannabis tax requirements in mind, ensuring proper expense categorization.</p>
      </div>

      <div style="background: var(--cbkny-white); padding: 1.5rem; border-radius: 0.5rem;">
        <div style="color: var(--cbkny-pink); font-size: 2rem; margin-bottom: 1rem;"><i class="fas fa-clock"></i></div>
        <h4 style="color: var(--cbkny-black); margin-bottom: 1rem;">Save Time</h4>
        <p>Pre-built formulas and categories eliminate hours of setup time and reduce errors.</p>
      </div>

      <div style="background: var(--cbkny-white); padding: 1.5rem; border-radius: 0.5rem;">
        <div style="color: var(--cbkny-pink); font-size: 2rem; margin-bottom: 1rem;"><i class="fas fa-chart-bar"></i></div>
        <h4 style="color: var(--cbkny-black); margin-bottom: 1rem;">Professional Reports</h4>
        <p>Generate audit-ready reports and financial statements with built-in formatting.</p>
      </div>
    </div>
  </section>

  <section style="text-align: center; margin: 4rem 0;">
    <h2 style="color: var(--cbkny-black); margin-bottom: 1rem;">Need Help Implementing?</h2>
    <p style="font-size: 1.25rem; color: var(--cbkny-gray); margin-bottom: 2rem;">Our bookkeeping services can help you set up and maintain these templates for your business.</p>
    <div style="display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap;">
      <a href="/services/monthly-bookkeeping" class="btn btn-primary" style="font-size: 1.1rem; padding: 1rem 2rem;">View Bookkeeping Services</a>
      <a href="/contact" class="btn" style="background: var(--cbkny-gray); color: white; font-size: 1.1rem; padding: 1rem 2rem;">Get Setup Help</a>
    </div>
  </section>
</main>
    ...
    case 'budget-template':
      content = `
        ...
        <div style="background: var(--cbkny-light-gray); padding: 1.5rem; border-radius: 0.5rem; margin-bottom: 2rem;">
          <h4 style="color: var(--cbkny-black); margin-bottom: 1rem;">Template Features:</h4>
          <ul style="margin: 0; padding-left: 1.5rem;">
            <li>✓ Cannabis-specific categories</li>
        ...
        <form id="download-form-budget" class="cbkny-download-form" data-file-id="budget-tracker" style="display: flex; flex-direction: column; gap: 1rem;">
          <input type="email" placeholder="Enter your email" required style="padding: 0.75rem; border: 2px solid #ddd; border-radius: 0.5rem;">
          <input type="text" placeholder="Business name" style="padding: 0.75rem; border: 2px solid #ddd; border-radius: 0.5rem;">
          <label style="display: flex; align-items: center; gap: 0.5rem; font-size: 0.9rem;">
            <input type="checkbox" required> I agree to receive cannabis accounting tips and updates
